...
import { getAllMatches, getAllSoloMatches } from '../../API/Api';
...
function MatchTables() {
  ...
  const match = useQuery<Match[]>("matches", getAllMatches);
  const soloMatch = useQuery<SoloMatch[]>("soloMatches", getAllSoloMatches);
